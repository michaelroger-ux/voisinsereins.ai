...
export default function VoisinSereins() {
  ...
  return (
    <div style={{position:"relative",height:"100vh",background:isMobile?"#e8e8e8":T.warmWhite,overflow:"hidden"}}>
      {/* Toggle button */}
      ...
      <div style={{
        ...
        margin:isMobile?"0 auto":"0",height:"100vh",background:T.warmWhite,
